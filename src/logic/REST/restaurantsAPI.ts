...
const updateRestaurant = async (body: Restaurant): Promise<ApiResponse<null>> => {
  return HttpRequest.networkRequest({
    url: baseUrl + 'restaurant/' + body.id,
...
export default { getRestaurants, resetServer, createRestaurant, getRestaurantById, updateRestaurant, deleteRestaurantById }
